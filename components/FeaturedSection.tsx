  ...
  return (
    <section className="h-screen flex flex-col justify-center pt-24 pb-8 px-6 lg:px-12 xl:px-16 max-w-[1600px] mx-auto w-full snap-start relative z-20">
      ...
      <div className="w-full mx-auto flex flex-col items-center">
        ...
        <Link 
          href="/properties" 
          className="bg-white hover:bg-brand/5 text-brand font-medium px-8 py-4 rounded-full shadow-[0_4px_20px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_25px_rgba(0,0,0,0.1)] transition-all border border-brand/10 hover:border-brand/30"
        >
          View All Properties
        </Link>
      </div>
