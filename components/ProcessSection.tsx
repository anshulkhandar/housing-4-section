...
export default function ProcessSection() {
  return (
    <section className="h-screen flex items-center justify-center py-20 px-6 lg:px-12 xl:px-16 max-w-[1600px] mx-auto w-full snap-start">
      <div className="bg-white rounded-[3rem] lg:rounded-[4rem] shadow-[0_4px_40px_rgba(0,0,0,0.08)] p-8 md:p-12 lg:p-20 border border-black/[0.04] w-full flex items-center justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-black text-lg mb-12 max-w-lg">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {steps.map((step, idx) => (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-brand flex items-center justify-center mb-0 md:mb-4 shrink-0 shadow-[0_2px_10px_rgba(184,155,94,0.4)]">
