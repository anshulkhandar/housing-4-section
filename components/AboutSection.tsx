...
export default function AboutSection() {
  return (
    <section className="flex flex-col items-center justify-center w-full snap-start relative z-10 h-[calc(100vh-130px)] bg-white overflow-hidden">
            ...
            {aboutBlocks.map((block, idx) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-black/70 leading-relaxed">{block.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          ...
          <div className="absolute top-4 left-4 w-[280px] h-[280px]">
            ...
            <div 
              ...
              style={{ 
                background: 'linear-gradient(135deg, rgba(184,155,94,0.12) 0%, rgba(184,155,94,0.05) 100%)',
                border: '2px solid rgba(184,155,94,0.08)'
              }}
            ></div>
          ...
          <div className="absolute bottom-4 right-4 w-[240px] h-[240px] z-20">
            ...
            <div 
              className="absolute inset-0 rounded-full z-0"
              style={{ 
                background: 'linear-gradient(135deg, rgba(184,155,94,0.10) 0%, rgba(184,155,94,0.03) 100%)',
                border: '2px solid rgba(184,155,94,0.06)'
              }}
            ></div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5 w-full relative">
            {features.map((feat, idx) => (
              <motion.div 
                ...
                className={`${feat.bg} p-6 lg:p-7 rounded-3xl flex flex-col items-start shadow-[0_2px_16px_rgba(0,0,0,0.06)] hover:shadow-[0_6px_30px_rgba(0,0,0,0.1)] transition-all duration-300 border border-black/[0.03]`}
              >
                <div className="bg-white p-3 rounded-2xl shadow-sm mb-4">
                  {feat.icon}
                </div>
                <h4 className="font-medium text-dark mb-2">{feat.title}</h4>
                <p className="text-sm text-black leading-relaxed">{feat.desc}</p>
              </motion.div>
            ))}
            ...
            >
              <Link 
                href="/contact"
                className="pointer-events-auto bg-brand hover:bg-brand-hover text-white text-base font-medium px-8 py-4 rounded-full shadow-[0_8px_30px_rgba(184,155,94,0.4)] hover:shadow-[0_12px_40px_rgba(184,155,94,0.5)] hover:-translate-y-1 transition-all flex items-center gap-2 border-4 border-white"
              >
