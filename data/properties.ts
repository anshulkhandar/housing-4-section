...
export const properties: Property[] = [
  {
    ...
    nearby: [
      { name: "Alexanderplatz", distance: "1.2 km" },
      { name: "Metro Station", distance: "300m" },
      { name: "Supermarket", distance: "250m" }
    ],
    description: "A beautifully maintained 2-room apartment in the heart of Berlin. Features a modern kitchen, spacious balcony, and plenty of natural light. Perfect for professionals looking for a premium living experience.",
    floor: "3rd",
    balcony: "Yes",
    parking: "Available",
    furnished: "Yes"
  },
  {
    ...
    coordinates: { lat: 52.5100, lng: 13.4350 },
    gallery: [
    ...
    nearby: [
      { name: "Spree River", distance: "200m" },
  ...
  },
  {
    ...
    nearby: [
      { name: "English Garden", distance: "800m" },
      { name: "University", distance: "1.5km" }
    ],
    description: "Compact but perfectly laid out studio in one of Munich's best neighborhoods. Ideal for students or single professionals.",
    floor: "2nd",
    balcony: "No",
    parking: "Street",
    furnished: "Yes"
  },
  {
    ...
    coordinates: { lat: 48.1500, lng: 11.5500 },
    gallery: [
    ...
    description: "Generous 4-room apartment suitable for families. Features two bathrooms, a large balcony, and a quiet courtyard.",
    floor: "1st",
    balcony: "Yes (Large)",
    parking: "Available",
    furnished: "No"
  },
  {
    ...
    nearby: [
      { name: "Landungsbrücken", distance: "1km" },
      { name: "Fish Market", distance: "1.5km" }
    ],
  ...
  },
  {
    ...
    coordinates: { lat: 53.5600, lng: 9.9800 },
    gallery: [
      "https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&q=80&w=1000"
    ],
    ...
    description: "Classic Hamburg Altbau with stucco ceilings, wooden floors, and a charming atmosphere in a lively neighborhood.",
    floor: "2nd",
    balcony: "Small",
    parking: "Street",
    furnished: "No"
  },
  {
    ...
    nearby: [
      { name: "Financial District", distance: "500m" },
      { name: "Central Station", distance: "1.2km" }
    ],
    description: "Exclusive penthouse offering breathtaking views of the Frankfurt skyline. Premium amenities and a large rooftop terrace.",
    floor: "8th (Top)",
    balcony: "Terrace",
    parking: "Included",
    furnished: "Yes"
  ...
  {
    title: "Quiet Retreat in Sachsenhausen",
    code: "FR05",
    city: "Frankfurt",
    rooms: 2,
    price: 1350,
    ...
    coordinates: { lat: 50.1000, lng: 8.6900 },
    gallery: [
      "https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1499916078039-922301b0eb9b?auto=format&fit=crop&q=80&w=1000"
    ],
    amenities: ["WiFi", "Heating", "Kitchen", "Washer"],
    nearby: [
      { name: "Main River", distance: "600m" },
      { name: "Museum Embankment", distance: "800m" }
    ],
    description: "Peaceful 2-room apartment located in the popular Sachsenhausen district. Close to restaurants, bars, and the river.",
    floor: "1st",
    balcony: "No",
    parking: "Street",
    furnished: "Partially"
  },
  {
    ...
    area: 55,
    availability: "01.09.2026",
    coordinates: { lat: 52.5000, lng: 13.4100 },
    gallery: [
      "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=1000"
    ],
    ...
    nearby: [
      { name: "Kreuzberg", distance: "800m" },
      { name: "Subway", distance: "200m" }
    ],
    description: "Modern smart-home ready apartment in a vibrant neighborhood.",
    floor: "2nd",
    balcony: "Yes",
    parking: "Available",
    furnished: "Yes"
  ...
  {
    title: "Premium Penthouse in Maxvorstadt",
    code: "MU13",
    city: "Munich",
    rooms: 4,
    price: 3200,
    area: 140,
    availability: "15.08.2026",
    coordinates: { lat: 48.1400, lng: 11.5700 },
    gallery: [
      "https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1512918728675-ed5a9ecdebfd?auto=format&fit=crop&q=80&w=1000"
    ],
    ...
    nearby: [
      { name: "Pinakothek", distance: "400m" },
      { name: "Central Station", distance: "1km" }
    ],
    description: "Luxurious penthouse with designer furniture and a large roof terrace.",
    floor: "6th (Top)",
    balcony: "Terrace",
    parking: "Included",
    furnished: "Yes"
  },
  {
    ...
    area: 82,
    availability: "01.10.2026",
    coordinates: { lat: 53.5700, lng: 10.0100 },
    gallery: [
      "https://images.unsplash.com/photo-1505691938895-1758d7feb511?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1484154218962-a197022b5858?auto=format&fit=crop&q=80&w=1000"
    ],
    amenities: ["WiFi", "Balcony", "Heating", "Kitchen", "Washer", "Elevator"],
    nearby: [
      { name: "Alster Lake", distance: "300m" },
      { name: "Park", distance: "100m" }
    ],
    description: "Bright apartment right next to the Alster lake with beautiful walking paths.",
    floor: "3rd",
    balcony: "Yes",
    parking: "Street",
    furnished: "No"
  ...
  {
    title: "Designer Studio near Messe",
    code: "FR06",
    city: "Frankfurt",
    rooms: 1,
    price: 1100,
    area: 42,
    availability: "01.07.2026",
    coordinates: { lat: 50.1150, lng: 8.6500 },
    gallery: [
      "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&q=80&w=1000",
      "https://images.unsplash.com/photo-1502005229762-cf1b2da7c5d6?auto=format&fit=crop&q=80&w=1000"
    ],
    amenities: ["WiFi", "Heating", "Kitchen", "Washer", "Elevator"],
    nearby: [
      { name: "Messe Frankfurt", distance: "500m" },
      { name: "Tram Station", distance: "150m" }
    ],
    description: "Compact, well-designed studio ideal for business travelers or expats.",
    floor: "4th",
    balcony: "No",
    parking: "Available",
    furnished: "Yes"
