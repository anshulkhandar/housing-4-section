    ...
    <div className="pt-32 pb-20 px-6 lg:px-12 xl:px-16 max-w-[1600px] mx-auto w-full min-h-screen">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-6">
        ...
        >
          ...
          <p className="text-black/60">Find your ideal home from our selection of premium apartments.</p>
        </motion.div>
        <motion.button 
          ...
          className="flex items-center gap-2 text-sm font-medium text-black/60 hover:text-dark transition-colors"
        >
      ...
      {filteredProperties.length === 0 ? (
        <div className="py-20 text-center">
          ...
          <p className="text-black/60">Try adjusting your search filters.</p>
        </div>
      ) : (
        <motion.div 
          layout
